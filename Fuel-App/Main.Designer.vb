...
Partial Class Main
    ...
    Private Sub InitializeComponent()
        ...
        lblUPrice = New Label()
        Button1 = New Button()
        CType(pctBox, ComponentModel.ISupportInitialize).BeginInit()
        SuspendLayout()
        ' 
        ' btnRefuel
        ' 
        ...
        ' pctBox
        ' 
        pctBox.Image = CType(resources.GetObject("pctBox.Image"), Image)
        pctBox.Location = New Point(57, 36)
        pctBox.Name = "pctBox"
        pctBox.Size = New Size(180, 180)
        ...
        Text = "Main"
        CType(pctBox, ComponentModel.ISupportInitialize).EndInit()
        ResumeLayout(False)
        PerformLayout()
    End Sub
    ...
    Friend WithEvents pctBox As PictureBox
